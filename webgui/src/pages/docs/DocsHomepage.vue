<template>
  <div class="page-docs column justify-center text-center">
    <div class="heading heading--large normal-line-height">Welcome to enpasos.ai docs</div>
    <div class="letter-spacing-300 text-size-16 text-weight-bold q-mb-md">
      Here we collect material that helps to approach artificial intelligence step by step.
    </div>

    <div class="q-mb-md">
      To make things more lively, we run small AI apps directly in your browser.
    </div>
