  ...
  <div class="doc-page-footer doc-brand">
    ...
    <div class="doc-page-footer__license row justify-center q-mt-md letter-spacing-225">
      <q-btn
        no-caps
        flat
        class="header-btn text-weight-bold letter-spacing-225"
        label="Imprint"
        @click="showImprint"
      />
      <q-btn
        no-caps
        flat
        href="https://www.iubenda.com/privacy-policy/57386469"
        target="_blank"
    ...
    <div class="doc-page-footer__copyright text-center q-pa-lg letter-spacing-100">
      <div>
        Copyright © 2022-present enpasos<sup>®</sup>
      </div>
      <div>
        This website has been derived from
        <a
          href="https://quasar.dev/docs/"
          target="_blank"
